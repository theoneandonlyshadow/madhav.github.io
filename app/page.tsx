...
export default function WebDeveloperPortfolio() {
	...
	if (isOffline) {
      ...
      <div className="px-4 py-10 md:py-20">
        ...
        >
          Thats crazy. Anyway, reload the page or go home.
        </motion.p>
        <motion.div
          initial={{
            opacity: 0,
        ...
        >
          <button onClick={() => { window.location.href = 'https://maxtac.tech' }} className="w-60 transform rounded-lg bg-black px-6 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200">
            Reload
          </button>
          <button
            onClick={() => {
