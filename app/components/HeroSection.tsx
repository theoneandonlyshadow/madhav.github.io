...
import { Nodejs, TypeScript, PostgreSQL, KaliLinux, Docker, MongoDB, JavaScript, HTML, CSS, EJS, Expressjs } from './Services';
	...
	return (
		<div className="relative min-h-screen flex items-center justify-center overflow-hidden">
			...
			<div className="relative z-10 max-w-5xl mx-auto px-4">
				<div className="text-center space-y-6">
					...
					<div className="space-y-4 sm:space-y-6 mt-6 sm:mt-8">
						<div className="flex flex-col items-center gap-4">
							<div className="flex items-center gap-3">
								...
								<h2 className="text-xl sm:text-2xl font-light tracking-wide text-blue-400">Fullstack Web Developer</h2>
								<span className="h-[1px] w-8 sm:w-12 bg-blue-500"></span>
							</div>
							<p className="text-base sm:text-lg text-gray-400 max-w-2xl px-4 sm:px-0">
								Associate SDE at <span className="text-blue-400"><a href="https://aimver.com/">Aimver</a></span>
							</p>
						</div>

						{/* Tech Stack Pills */}
						<div className="flex flex-wrap justify-center gap-2 sm:gap-3 mt-6 sm:mt-8 px-4 sm:px-0">
							{['Node.js', 'TypeScript', 'Express.js', 'Docker', 'PostgreSQL', 'MongoDB', 'JavaScript ESM/CJS', 'Socket.IO', 'HTML/CSS', 'REST API', 'CRUD Operations'].map((tech) => (
								<span
									key={tech}
					...
					<div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mt-8 sm:mt-12 px-4 sm:px-0">
						<a href="https://github.com/theoneandonlyshadow" className="group relative inline-flex items-center justify-center">
							<GitHub />
						</a>
						<a href="https://www.linkedin.com/in/theoneandonlyshadow/" className="group relative inline-flex items-center justify-center">
							<LinkedIn />
						</a>
			...
			<div className="absolute bottom-8 inset-x-0 flex flex-col items-center animate-bounce">
				<span className="text-gray-400 text-sm mb-2 text-center">See what else I got</span>
